...
import com.siabucketup.ecotaxi.app.*
import com.siabucketup.ecotaxi.app.util.Result
import com.siabucketup.ecotaxi.domain.JsonRepository
import com.siabucketup.ecotaxi.model.Flags
import com.siabucketup.ecotaxi.model.Json
import com.siabucketup.ecotaxi.model.Shape
...
class JsonRepositoryImpl @Inject constructor(private val appContext: Context) : JsonRepository {
    ...
    private fun formJsonClass(
        ...
        points.add(arrayListOf(toSaveData.pointLeftTop.x, toSaveData.pointLeftTop.y))
        points.add(arrayListOf(toSaveData.pointRightBottom.x, toSaveData.pointRightBottom.y))
